...
public sealed class TemplateService(ZmgDbContext db) : ITemplateService
{
    ...
    public async Task<OperationResult<TemplateTaskDto>> AddTaskAsync(Guid templateId, AddTemplateTaskInput input)
    {
        ...
        var nextOrder = await NextSortOrder(templateId, input.Phase);
    ...
    public async Task<OperationResult<TemplateTaskDto>> UpdateTaskAsync(Guid id, UpdateTemplateTaskInput input)
    {
        ...
        {
            task.SortOrder = await NextSortOrder(task.ChecklistTemplateId, input.Phase, excludeTaskId: id);
    ...
    public async Task<OperationResult> ReorderTasksAsync(Guid templateId, ReorderTemplateTasksInput input)
    {
    ...
    private async Task<int> NextSortOrder(Guid templateId, Phase phase, Guid? excludeTaskId = null) =>
